    ...
    <div class="transaction-list">
      <div class="list-header">
        ...
        <div class="header-actions">
          <button class="icon-btn" :class="{ 'icon-btn--active': showFilters || anyFilter }" @click="showFilters = !showFilters" aria-label="Filter">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="22" height="22">
              <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>
            </svg>
          </button>
          <button class="icon-btn" :class="{ 'icon-btn--active': settingsActive }" @click="$emit('settings')" aria-label="Einstellungen">
